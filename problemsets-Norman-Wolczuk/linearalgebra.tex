...
\section*{Subspaces and Bases}
	...
	\begin{Enum}
		\item $A=\{\vec x\in\R^2:x=\mat{a\\0}\text{ for some }a\in\Z\}$.
		\item $B=\{\vec x\in\R^2:x\neq \mat{0\\0}\}$.
		\item $C=\{\vec x\in\R^2:x=\mat{0\\t}\text{ for some }t\in\R\}$.
		\item $D=\{\vec x\in\R^2:x=\mat{0\\t}+\vec{1\\1}\text{ for some }t\in\R\}$.
		\item $E=\{\vec x\in\R^2:x=\mat{0\\t}\text{ or }\vec x=\mat{t\\0}\text{ for some }t\in\R\}$.
		\item $F=\{\vec x\in\R^2:x=t\mat{3\\1}\text{ for some }t\in\R\}$.
