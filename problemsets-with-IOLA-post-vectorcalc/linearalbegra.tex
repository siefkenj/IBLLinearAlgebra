...
\section*{About the Document}
	...
	This document is a hybird of many linear algebra resources, including those of
	...
	This document is a mix of student projects, problemsets, and labs.
...
\begin{itemize}
	\item We denote the restriction on the hover board's movement by the vector
	...
	\item We denote the restriction on the magic carpet's movement by the vector
...
a symbolic represenation using vector noation. Also, include a convincing
...
\newpage
\pagestyle{iola}
\section*{Task 1.3: The Carpet Riding, Getting Back Home}
