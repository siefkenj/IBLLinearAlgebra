...
\definecolor{barcolor}{rgb}{.2,.6,1.0}
...
\definecolor{defcolor}{rgb}{.1,.7,.3}
...
\begin{document}
% resized the pages, so inserted blank pages to keep pagenumbers
% consistent.  Can be removed!!
\newpage
x
\newpage
x
...
\section*{Eigenvectors and Eigenvalues Cont.}
	...
	of $\lambda_i$ is the number of times $\lambda_i$ occurs as a factor of the
