...
\SavedDefinitionRender{Eigenvector}\index[definitions]{Eigenvector}\index[definitions]{Eigenvalue}
...
\Heading{Characteristic Polynomial}\index[definitions]{Characteristic polynomial}
