...
\Heading{Range}
\SavedDefinitionRender{Range}\index[definitions]{Linear transformation!range (image)}
...
\SavedDefinitionRender{RankofaLinearTransformation}\index[definitions]{Linear transformation!rank}
...
\SavedDefinitionRender{NullSpace}\index[definitions]{Linear transformation!null space}
...
\begin{theorem}
	Let $T:\R^n\to\R^m$ be a linear transformation. Then $\Null(T)\subseteq \R^n$ is a subspace\index{Subspace!null space}.
\end{theorem}
\begin{proof}
...
\SavedDefinitionRender{Nullity}\index[definitions]{Linear transformation!nullity}
...
\SavedDefinitionRender{FundamentalSubspaces}\index[definitions]{Matrix!fundamental subspaces}
...
\SavedDefinitionRender{Transpose}\index[definitions]{Matrix!transpose}
...
\SavedDefinitionRender{InducedTransformation}\index[definitions]{Linear transformation! matrix representation}
...
\SavedDefinitionRender{RankofaMatrix}\index[definitions]{Matrix!rank}
\SavedDefinitionRender{NullityofaMatrix}\index[definitions]{Matrix!nullity}
...
\begin{theorem}(Rank-nullity Theorem for Matrices)\index{Matrix!rank-nullity theorem} For a matrix $A$,
\[
...
\begin{theorem}(Rank-nullity Theorem for Linear Transformations)\index{Linear transformation!rank-nullity theorem} Let $\mathcal T$ be a linear transformation.
Then
\[
