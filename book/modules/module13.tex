...
\SavedDefinitionRender{ChangeofBasisMatrix}\index[definitions]{Matrix!change of basis}
...
\SavedDefinitionRender{LinearTransformationinaBasis}\index[definitions]{Linear transformation! matrix representation}
...
\SavedDefinitionRender{SimilarMatrices}\index[definitions]{Matrix!similar matrices}
