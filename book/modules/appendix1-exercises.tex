	...
	\begin{problist}
		...
		\begin{solution}
			\begin{enumerate}
				...
				\item $x\mat{0 \\ 1}+y\mat{0 \\ 1}+z\mat{0 \\ 1}=\mat{0 \\ 3}$
			\end{enumerate}
		\end{solution}
		...
		\begin{solution}
			\begin{enumerate}
				...
				\item There are vectors $\vec{b}$ that makes the system consistent.
					For instance, any vector $\vec b=\mat{t \\ 2t}$ where $t\in\R$
					makes the system consistent. Since there are infinitely many
					real numbers, we conclude that there are infinitely many vectors
					$\vec b$ that makes the system consistent.
				...
				\item There are vectors $\vec b$ that makes the system inconsistent.
					...
					$t\in\R$ ($t\ne 0$) makes the system inconsistent. Since
					there are infinitely many real numbers, we conclude that there
					are infinitely many vectors $\vec b$ that makes the system inconsistent.
			\end{enumerate}
		\end{solution}
		...
		\begin{solution}
			\begin{enumerate}
				...
				\item True. Take $m=0$, $c=0$. The equation then becomes $y=0$. The
				...
				\item False. The $x$-axis in $\R^{3}$ can be described as
					...
					becomes $z=m_{2}y$. However, for each choice of $m_{2}$, $\mat
					{0 \\ 1 \\ m_2}$ is a solution to the system which does not lie
