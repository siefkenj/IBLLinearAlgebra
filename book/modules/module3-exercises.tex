		...
		\begin{solution}			
			...
			\begin{tikzpicture}[baseline = (current bounding box.north)]
				\begin{axis}[
					...
					\fill [mygreen] (0,0) circle[radius=2pt];
					\fill [mygreen] (-1,-1) circle[radius=2pt];
					\fill [mygreen] (0,2) circle[radius=2pt];
				\end{axis}
			...
			\begin{tikzpicture}[baseline = (current bounding box.north)]
				\begin{axis}[
					...
					\fill [myorange] (0,2) circle[radius=2pt];
					\fill [myorange] (-1,-2) circle[radius=2pt];
					\fill [myorange] (1,5) circle[radius=2pt];
					\fill [myorange] (0,1) circle[radius=2pt];
					\fill [myorange] (1,3) circle[radius=2pt];
					\fill [myorange] (0,-1) circle[radius=2pt];
				\end{axis}
			...
			\begin{enumerate}
				...
				\begin{tikzpicture}[baseline = (current bounding box.north)]
					\begin{axis}[
						...
						\fill [WildStrawberry] (2,2) circle[radius=2pt];
						\fill [WildStrawberry] (1,0) circle[radius=2pt];
						\fill [WildStrawberry] (0,-2) circle[radius=2pt];
						\fill [WildStrawberry] (1,1) circle[radius=2pt];
						\fill [WildStrawberry] (0,-1) circle[radius=2pt];
						\fill [WildStrawberry] (0,0) circle[radius=2pt];
					\end{axis}
				...
				\begin{tikzpicture}[baseline = (current bounding box.north)]
					\begin{axis}[
						...
						\fill [WildStrawberry] (0,-3) circle[radius=2pt];
						\fill [WildStrawberry] (0,-2) circle[radius=2pt];
						\fill [WildStrawberry] (0,-1) circle[radius=2pt];
						\fill [WildStrawberry] (0,0) circle[radius=2pt];
						\fill [WildStrawberry] (1,-1) circle[radius=2pt];
						\fill [WildStrawberry] (1,0) circle[radius=2pt];
						\fill [WildStrawberry] (1,1) circle[radius=2pt];
						\fill [WildStrawberry] (2,1) circle[radius=2pt];
						\fill [WildStrawberry] (2,2) circle[radius=2pt];
						\fill [WildStrawberry] (3,3) circle[radius=2pt];
					\end{axis}
				\end{tikzpicture}
				...
				\begin{tikzpicture}[baseline = (current bounding box.north)]
					...
					\foreach \x [evaluate=\x as \ymax using 2*\x] in {0,...,4} {
						\foreach \y in {0,...,\ymax} {
							\fill [orange] (\x,-2+\y/2) circle[radius=2pt];
						}
					}
				\end{tikzpicture}
