	...
	\begin{problist}
		...
		\begin{solution}
			\begin{enumerate}
				...
				Notice that we obtain the orange points when we add additional $S$ to the set sum. Since we are considering the infinite sum $S+S+S+S+\cdots$, the process continues infinitely.
			\end{enumerate}
		\end{solution}
