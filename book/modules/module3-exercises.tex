		...
		\begin{solution}
			...
			\begin{tikzpicture}[baseline = (current bounding box.north)]
				\begin{axis}[
					...
					\fill [WildStrawberry] (0,2) circle (2pt);
					\fill [WildStrawberry] (-1,-2) circle (2pt);
					\fill [WildStrawberry] (1,5) circle (2pt);
					\fill [WildStrawberry] (0,1) circle (2pt);
					\fill [WildStrawberry] (1,3) circle (2pt);
					\fill [WildStrawberry] (0,-1) circle (2pt);
				\end{axis}
		...
		\begin{solution}
			\begin{enumerate}
				...
				\begin{tikzpicture}[baseline = (current bounding box.north)]
					...
					\end{axis}
				\end{tikzpicture}
				\item The set $(S+S)+S$ and $S+(S+S)$ are equal since vectors are associative. This means that $S+S+S$ is well-defined and we can drop the parentheses, so the expression $S+S+S$ makes sense.
				\item 
				\begin{tikzpicture}[baseline = (current bounding box.north)]
					\begin{axis}[
						anchor=origin,
						...
						\fill [WildStrawberry] (1,0) circle (2pt);
						\fill [WildStrawberry] (1,1) circle (2pt);
						\fill [myorange] (2,0) circle (2pt);
						\fill [WildStrawberry] (2,1) circle (2pt);
						\fill [WildStrawberry] (2,2) circle (2pt);
						\fill [myorange] (3,2) circle (2pt);
						\fill [WildStrawberry] (3,3) circle (2pt);
						\fill [myorange] (4,4) circle (2pt);
					\end{axis}
				\end{tikzpicture}
				
				Notice that we obtain the orange points when an additional $S$ is added to the set sum $S+S+S$. We can consider the set $(S+S+S)+S$ as the union of three translated copies of $S+S+S$. Since we are considering the infinite sum $S+S+S+S+\cdots$, the process continues infinitely.
			\end{enumerate}
		\end{solution}
