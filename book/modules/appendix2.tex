	...
	\begin{example}
		...
		$C$ is in reduced row echelon form and column 1, 2, 3 are the pivot columns. The fourth property fails for $A$. The first and second property fails for $B$. The second and third property fails for $D$.
	\end{example}
	...
	\begin{example}
		...
		The corresponding augmented matrix of the system is
		\[
			\begin{bmatrix}[ccc|c]
			1 & 1 & 1 & 1\\
			0 & 1 & -1 & 2
		...
		The matrix is already in pre-reduced row echelon form, so we need to zero above each pivot.
		\[
			\begin{bmatrix}[ccc|c]
			1 & 1 & 1 & 1\\
			0 & 1 & -1 & 2
		...
		To solve the system
		\[
			\systeme{x+2z=-1,y-z=2}
		\]
		for $(x,y,z)$, we introduce the arbitrary equation $z=t$ and solve the system in terms of $t$.
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\addplot3 [surf,domain=-5:0,y domain=-10:10,samples=2, opacity=.8, mygreen] ({x}, {y}, {x/2});
			\addplot3 [surf,domain=-5:0,y domain=-10:10,samples=2, opacity=.8, myorange] ({x}, {y}, {0});
			\addplot3 [surf,domain=-5:0,y domain=-10:10,samples=2, opacity=.9, WildStrawberry] ({x}, {y}, {-x/2});
			\addplot3 [surf,domain=0:5,y domain=-10:10,samples=2, opacity=.9, WildStrawberry] ({x}, {y}, {-x/2});
			\addplot3 [surf,domain=0:5,y domain=-10:10,samples=2, opacity=.8, myorange] ({x}, {y}, {0});
			\addplot3 [surf,domain=0:5,y domain=-10:10,samples=2, opacity=.8, mygreen] ({x}, {y}, {x/2});
			\end{axis}
		\end{tikzpicture}
		~~~~~
		\begin{tikzpicture}
			...
			\addplot3 [surf,domain=-5:-2.5,y domain=-10:10,samples=2, opacity=.8, mygreen] ({x}, {y}, {2*x+5});
			\addplot3 [surf,domain=-5:2.5,y domain=-10:10,samples=2, opacity=.8, myorange] ({x}, {y}, {0});
			\addplot3 [surf,domain=-2.5:0,y domain=-10:10,samples=2, opacity=.8, mygreen] ({x}, {y}, {2*x+5});
			\addplot3 [surf,domain=-2.5:0,y domain=-10:10,samples=2, opacity=.9, WildStrawberry] ({x}, {y}, {-2*x+5});
			\addplot3 [surf,domain=0:2.5,y domain=-10:10,samples=2, opacity=.9, WildStrawberry] ({x}, {y}, {-2*x+5});
			\addplot3 [surf,domain=2.5:5,y domain=-10:10,samples=2, opacity=.9, WildStrawberry] ({x}, {y}, {-2*x+5});
			\addplot3 [surf,domain=2.5:5,y domain=-10:10,samples=2, opacity=.8, myorange] ({x}, {y}, {0});
			\addplot3 [surf,domain=0:2.5,y domain=-10:10,samples=2, opacity=.8, mygreen] ({x}, {y}, {2*x+5});
			\end{axis}
		\end{tikzpicture}
	\end{center}
