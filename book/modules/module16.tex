...
\SavedDefinitionRender{Diagonalizable}\index[definitions]{Diagonalizable}
...
\SavedDefinitionRender{Eigenspace}\index[definitions]{Eigenspace}\index[definitions]{Eigenvalue!geometric multiplicity}\index[definitions]{Eigenvalue!algebraic multiplicity}\index{Characteristic polynomial}
