...
\SavedDefinitionRender{Unitncube}\index[definitions]{Unit $n$-cube}
...
\SavedDefinitionRender{Determinant}\index[definitions]{Determinant}
...
\SavedDefinitionRender{OrientationPreservingLinearTransformation}\index[definitions]{Linear transformation!orientation preserving/reversing}
...
\Heading{Determinants of Composition}\index{Linear transformation!composition}
