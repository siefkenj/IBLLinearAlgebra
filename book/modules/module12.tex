...
\SavedDefinitionRender{IdentityFunction}\index[definitions]{Linear transformation!identity}
...
\SavedDefinitionRender{InverseFunction}\index[definitions]{Linear transformation!inverse}
...
\SavedDefinitionRender{Onetoone}\index[definitions]{Linear transformation!one-to-one}
...
\SavedDefinitionRender{Onto}\index[definitions]{Linear transformation!onto}
...
Using the rank-nullity theorem\index{Linear transformation!rank-nullity theorem}, we can start developing a list of properties that are equivalent to invertibility of a
...
\SavedDefinitionRender{IdentityMatrix}\index[definitions]{Matrix!identity}
...
\SavedDefinitionRender{MatrixInverse}\index[definitions]{Matrix!inverse}
...
\Heading{Elementary Matrices}\index[definitions]{Matrix!elementary matrix}
