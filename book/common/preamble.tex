...
\newenvironment{beforeyouread}{
Before you read, make sure you are comfortable with the following tasks.
...
\newcommand\quickcheck[1]{\vspace{-0.5cm}\item[] {\footnotesize \textsc{Quick Check.} \textrm{#1}}}
