...
% an internal version of nicematrix because the TeXlive version doesn't have the necessary features.
% Update 2026-07-08: The TeXlive version of nicematrix is now up to date, so we use that.
...
\usepackage{bm}
\usepackage{systeme}
% systeme v0.4 (2025/05/13) dropped \sysdelim in favour of key/value settings.
% \providecommand keeps us working with both the old and the new package.
\providecommand{\sysdelim}[2]{\setsysteme{delim={#1,#2}}}
