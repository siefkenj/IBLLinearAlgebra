		...
		\item $C=\Set*{\vec x\in\R^2 \given \vec x=\mat{0\\t}\text{ for some }t\in\R}$.
			\begin{solution}
				...
				\begin{enumerate}[label=(\roman*)]
					...
					\item Let $\vec u=\mat{0\\t}\in C$ and let $\alpha$ be any scalar.
						Then $\alpha\vec u=\mat{0\\\alpha t}\in C$. 
				\end{enumerate}
			\end{solution}
		...
		\item $F=\Set*{\vec x\in\R^2 \given \vec x=t\mat{3\\1}\text{ for some }t\in\R}$.
			\begin{solution}
				...
				\begin{enumerate}[label=(\roman*)]
					...
					\item Let $\vec u=t\mat{3\\1}\in F$ and let $\alpha$ be any scalar.
						Then $\alpha\vec u=(\alpha t)\mat{3\\1}\in F$. 
				\end{enumerate}
			\end{solution}
		\item $G=\Span\left\{\mat{1\\1}\right\}$.
			\begin{solution}
				...
				\begin{enumerate}[label=(\roman*)]
					...
					\item Let $\vec u=t\mat{1\\1}\in G$ and let $\alpha$ be any scalar.
						Then $\alpha\vec u=(\alpha t)\mat{1\\1}\in G$. 
				\end{enumerate}
		...
		\item $H=\Span\Set{\vec u,\vec v}$ for some unknown vectors $\vec u,\vec v\in\R^2$.
			\begin{solution}
				...
				\begin{enumerate}[label=(\roman*)]
					...
					\item Let $\vec x=\alpha_1\vec u+\alpha_2\vec v\in H$ and let $\beta$ be any scalar.
						Then $\beta\vec u=(\beta\alpha_1)\vec u+(\beta\alpha_2)\vec v\in H$.
				\end{enumerate}
			\end{solution}
	\end{parts}
