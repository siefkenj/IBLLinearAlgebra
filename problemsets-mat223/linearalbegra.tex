...
\end{lesson}
	...
	vectors in their $\mathcal V$-basis representation. Here, $A$ and $\mathcal V$
	...
	\begin{parts}
		...
		\item Describe how you can use $P$ and $P^{-1}$ to easily compute
			...
			\begin{solution}
				Computing $[A]_{\mathcal V}[\vec y]_{\mathcal V}$ is easy, since
				$[A]_{\mathcal V}$ just multiplies each coordinate of $[\vec y]_{\mathcal V}$
				...
				\[
					A[\vec v]_{\mathcal E}=P[A]_{\mathcal V}P^{-1}[\vec v]_{\mathcal E}
				\]
				since
				\[
					P[A]_{\mathcal V}P^{-1}[\vec v]_{\mathcal E}
					=P[A]_{\mathcal V}[\vec v]_{\mathcal V}
