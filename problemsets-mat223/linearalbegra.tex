...
\end{center}
	...
	\begin{parts}
		\item The points $A=(2,1)$ and $B=(3,-1)$ are given in street coordinates.
			...
			\begin{solution}
				$A=\frac{1}{5}(5,-4)$ in east-north coordinates.

				We obtain this by finding the vector $2\vec d_1+\vec d_2$. 
			\end{solution}
		...
		\item Define $\vec e_1=\mat{1\text{ east}\\0\text{ north}}$ and 
			...
			Does $\Span\{\vec e_1,\vec e_2\} = \Span\{\vec d_1,\vec d_2\}$?
			\begin{solution}
	...
	\question
	Let $\mathcal E=\{\vec e_1,\vec e_2\}$ be the standard basis for $\R^2$ and 
	let $\mathcal C=\{\vec c_1,\vec c_2\}$ where $\vec c_1=\mat{2\\1}_{\mathcal E}$
