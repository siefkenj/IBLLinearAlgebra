	...
	\begin{parts}
		\item What is the rank and nullity of $A^T$?
			\begin{solution}
				...
				$R_3 \to R_3 - 2R_1 + R_2$. Neither of the first two rows can be
	...
	\begin{parts}[resume]
		...
		operations?
			\begin{solution}
				...
				$E_1A$ is the result applying the row operation $R_3\to R_3+2R_1$
		...
		operation $R_3\to R_3-2R_1$ to $E_1$ be? Compute and verify.
			\begin{solution}
				...
				$R_3\to R_3-2R_1$ should undo the operation $R_3\to R_3+2R_1$.
			\end{solution}
