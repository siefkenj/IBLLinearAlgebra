	...
	\begin{parts}
		...
		\item Can you give another?
			\begin{solution}
				...
				More interestingly, $\mat{-1\\1}$ is an eigenvector with corresponding
				eigenvalue $\frac{1}{2}$. We can compute:
				\[
					T\mat{-1\\1}
					=T\left(\mat{0\\1}-\mat{1\\0}\right)
					=T\mat{0\\1}-T\mat{1\\0}
					=\mat{\frac{1}{2}\\1}-\mat{1\\\frac{1}{2}}
