	...
	\begin{parts}
		...
		\item Can you relate the columns of $M$ to the range of $T_M$?
			\begin{solution}
				...
				$T_M$. By an identical argument, the second column of $M$ is also
	...
	\begin{parts}
		...
		\item Describe the null space of $A$.
			\begin{solution}
				...
				\]
				or in other words if $\vec x=\mat{0\\0\\t}$ for some real number $t$,
				just like in the previous part.				
			\end{solution}
	...
	\begin{parts}
		\item How does the row space of $B$ relate to the row space of $C$?
			\begin{solution}
				...
				Both rows of $C$ can be written as linear combinations of the 
				rows of $B$, and so
				\[
					\Span\Set*{\mat{1\\0\\-1},\mat{0\\1\\2}}
					\subseteq
					\Span\Set*{\mat{1\\2\\3},\mat{1\\1\\1}}.
				\]
				Similarly, both rows of $B$ can be written as linear combations
				of the rows of $C$, and so:
				\[
					\Span\Set*{\mat{1\\2\\3},\mat{1\\1\\1}}
					\subseteq
					\Span\Set*{\mat{1\\0\\-1},\mat{0\\1\\2}}.
		...
		\item How does the null space of $B$ relate to the null space of $C$?
			\begin{solution}
				...
				A vector is in the null space of $B$ or the null space
				of $C$ if and only if it is perpendicular to the row space of $B$
				or the row space of $C$, respectively. But the row spaces of $B$
				and $C$ are equal by the previous part, and so their null spaces
				must also be equal. 
			\end{solution}
