...
\end{lesson}
	...
	\begin{parts}[resume]
		\item Compute $T\mat{2\\1}$ and $T\mat{5\\3}$.
			\begin{solution}[inline]
				$T\mat{2\\1}=\mat{4\\2}$ and $T\mat{5\\3}=\mat{5\\3}$.
			\end{solution}
		...
		\item Compute the result of $T\mat{\alpha\\\beta}_{\mathcal C}$ and express the result in the
			...
			\begin{solution}
				...
				$[\vec v]_{\mathcal C}=\mat{\alpha\\\beta}_{\mathcal C}$, then 
		...
		\item Find $[T]_{\mathcal C}$, the matrix for $T$ in the $\mathcal C$ basis.
			\begin{solution}
				...
				$[T]_{\mathcal C}\mat{1\\0}_{\mathcal C}=\mat{2\\0}_{\mathcal C}$
				and $[T]_{\mathcal C}\mat{0\\1}_{\mathcal C}=\mat{0\\1}_{\mathcal C}$,
				so these two vectors must be the first and second columns of 
				$[T]_{\mathcal C}$, respectively.
			\end{solution}
		\item Find $[T]_{\mathcal E}$, the matrix for $T$ in the standard basis.
			\begin{solution}
				$[T]_{\mathcal E}=\mat{7&-10\\3&-4}$
				
				To determine this, we first find $[T\xhat]_{\mathcal E}$ and 
				$[T\yhat]_{\mathcal E}$, which by the same reasoning as the previous
				part will be the first and second columns of $[T]_{\mathcal E}$, 
				respectively. 

				We first find that $\xhat=3\vec c_1-\vec c_2$ and 
				$\yhat=-5\vec c_1+2\vec c_2$. Then since $T$ is linear we compute
				\[
					[T\xhat]_{\mathcal E}
					=[T(3\vec c_1-\vec c_2)]_{\mathcal E}
					=3[T(\vec c_1)]_{\mathcal E}-[T(\vec c_2)]_{\mathcal E}
					=3\mat{4\\2}_{\mathcal E}-\mat{5\\3}_{\mathcal E}
					=\mat{7\\3}_{\mathcal E}
				\]
				and
				\[
					...
					=-5\mat{4\\2}_{\mathcal E}+2\mat{5\\3}_{\mathcal E}
					=\mat{-10\\-4}_{\mathcal E}
				\]
