\begin{exercises}
	...
	\begin{problist}
		...
		\begin{solution}
			\begin{enumerate}
				\item
					...
					\end{enumerate}
				\item
				%% I don't know how you want these to be labelled. Need more feedback
		...
		\begin{solution}
			%%I don't know how you want me to model/draw this or if i should keep a solutions part
		\end{solution}
