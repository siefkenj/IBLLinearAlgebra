...
The rank of a linear transformation can be used as a measure of
...
Akin to the rank--range connection, there is a special number call the \emph{nullity} of a linear transformation
...
\begin{example}
	Let $\mathcal T$ be the transformation induced by the matrix $M=M=\mat{1&2&5\\2&-2&-2}$,
	...
	\]
	Meanwhile, $\vec v=3\xhat-3\zhat$ implies that $[\vec v]_{\mathcal E}=\mat{3\\0\\-3}$. Therefore,
	\[
	    [\mathcal T_{M}\vec v]_{\mathcal E'}=\mat{1&2&5\\2&-2&-2}\mat{3\\0\\-3}=\matc{-12\\12}.
	\]
...
There is an alternative definition of the rank of a matrix which commonly appears. This time,
