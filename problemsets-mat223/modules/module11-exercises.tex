	...
	\begin{problist}
		...
		\begin{solution}
			\begin{enumerate}
				...
				\item the column space of $M_P$ is $\Span\Set*{\mat{1\\0\\0},\mat{0\\1\\0}} =$ the $xy$-plane. The column space of a matrix is the same as the range of its induced transformation.
				\item the null space of $P$ and $M_P$ is $\Span\Set*{\mat{0\\0\\1}} =$ the $z$-axis. The null space of a matrix is the same as the null space of its induced transformation.
			\end{enumerate}
		\end{solution}
