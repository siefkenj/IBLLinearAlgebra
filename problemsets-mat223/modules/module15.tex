...
\begin{example}
	...
	\Span\Set*{\mat{2\\3}},
	\]
	and so the eigenvectors with the eigenvalue $4$ are $\vec v_2 = k\mat{2\\3}$ where $k \neq 0$.
...
\begin{example}
	...
	\end{align*}
	Thus, we conclude that one eigenvector with eigenvalue $\frac{5-\sqrt{33}}{2}$ is $\vec v_1 = \matc{\frac{3+\sqrt{33}}{6}\\-1}$. Similarly, one eigenvector corresponding to eigenvalue $\frac{5+\sqrt{33}}{2}$ is $\vec v_2=\matc{\frac{3-\sqrt{33}}{6}\\-1}$ is one eigenvector with eigenvalue $\lambda_2 = \frac{5+\sqrt{33}}{2}$.
\end{example}
