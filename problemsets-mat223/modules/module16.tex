...
\begin{example}
	...
	XXX Finish (eigenvalues are 4,8,12)
\end{example}
...
\begin{example}
	Is the matrix $R=\mat{0&-1\\0&1}$ diagonalizable?
...
\begin{example}
	Is the matrix $D=\mat{3&0\\0&3}$ diagonalizable?

	For every vector $\vec v\in \R^2$, we have $D\vec v=3\vec v$, and so every
...
\begin{example}
	Is the matrix $J=\mat{3&1\\0&3}$ diagonalizable?

	XXX Finish
\end{example}

\begin{example}
	Is the matrix $K=\mat{3&1\\0&2}$ diagonalizable?
...
\begin{example}
	Let $R=\mat{0&-1\\0&1}$ and find the geometric and algebraic multiplicity of each eigenvalue of $R$.
	
	XXX Finish
\end{example}

\begin{example}
	Let $D=\mat{3&0\\0&3}$ and find the geometric and algebraic multiplicity of each eigenvalue of $D$.
	
	XXX Finish
\end{example}

\begin{example}
	Let $J=\mat{3&1\\0&3}$ and find the geometric and algebraic multiplicity of each eigenvalue of $J$.
	
	XXX Finish
\end{example}

\begin{example}
	Let $K=\mat{3&1\\0&2}$ and find the geometric and algebraic multiplicity of each eigenvalue of $K$.
