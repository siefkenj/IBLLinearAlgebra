...
\begin{example}
	...
	\]
	We know that on the one hand,
	\[
	    \vec r = 2\xhat+2\yhat
	\]
	and on the other hand, 
	\[
	    \vec r = a\vec x+b\vec y = a(\xhat-\yhat)+b(3\xhat-\yhat)=(a+3b)\xhat + (a+b)\yhat.
	\]
	...
	\]
	we have $a=-4$ and $b=2$ as the only solution. Thus, $\vec r$ is a linear combination of $\vec x$ and $\vec y$. More specifically, 
	\[
