...
\begin{example}
	...
	By definition, $\vec r$ is a linear combination of $\vec x$ and $\vec y$ if there exist scalars $a,b\in\R$ such that
	\begin{align*}
	    \vec r&=a\vec x+b\vec y\\
	   \implies 2\xhat+2\yhat&=a(\xhat-\yhat)+b(3\xhat-\yhat)\\
	   \implies 2\xhat+2\yhat&=(a+3b)\xhat+(-a-b)\yhat.
	\end{align*}
	...
	\]
	which gives the solution as $a=-4$ and $b=2$. Therefore, $\vec r$ is a linear combination of $\vec x$ and $\vec y$. More specifically, 
	\[
