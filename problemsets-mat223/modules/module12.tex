...
\begin{example}
	...
	Notice that $\mathcal P(\yhat)=\mathcal P(2\yhat)=\vec 0$, therefore $\mathcal P$ is not one-to-one.
	Let $\mathcal Q: R^2\to\R^2$ be rotation clockwise by $15^\circ$. Therefore, $\mathcal R$ and $\mathcal Q$ will undo each other. In other words,
	\[
