...
\begin{example}
	...
	Let $\vec u = \mat{u_1\\u_2}$ and $\vec v = \mat{v_1\\v_2}$ be in $\mathcal V$.
	...
	\begin{itemize}
		\item[(i)] $\vec u + \vec v \in \mathcal V$; and
	...
	\[
		...
		0+0=0
	\]
	Since $\vec u + \vec v$ satisfies the property that $x+2y=0$, 
	...
	Finally, since $\vec 0 = \mat{0\\0}$ and $0+2(0)=0$, 
	we conclude that $\vec 0\in\mathcal V$. 
	
	Furthermore, this shows that $\mathcal V$ is non-empty.
