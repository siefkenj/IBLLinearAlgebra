...
\begin{example}
    ...
    % Might need some more explanation on how the span of B1 is equal to \ell and the span of B2 is equal to \ell. Not sure what exactly to put though.
    % I was considering writing down \Span\Set*{\mat{1\\2}} = \Span\Set*{\mat{-2\\-4}} = \Span\Set*{\mat{1/2\\1}} and making B_2 = \Set*{\mat{-6\\-12}} to show that a) the element(s) of a basis does not have to be the same vectors *explicitly* written down in the question, since the subspace we are finding a basis for, is formed by the span of those vectors anyways and b) once you find the "smallest" set of vectors which span the subspace, you've already done all the work to find a basis; there's hardly anything left after that. Not sure if including all that would overwhelm the student. Could it be too much information all at once?
