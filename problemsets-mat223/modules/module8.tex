...
\begin{example}
	...
	\end{equation}
	for some unknown scalars $x$ and $y$. Then, since on the on hand,
	\[
	    \vec v = 2\xhat-\yhat
	\]
	and on the other hand, 
	\[
	    x\vec b_1 + y\vec b_2= x(\xhat+\yhat)+3y\yhat=x\xhat+(x+3y)\yhat,
	\]
	substituting $\vec v$ and $x\vec b_1 + y\vec b_2$ into \eqref{e1}, we have
	\[
