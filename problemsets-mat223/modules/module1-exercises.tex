		...
		\begin{enumerate}
			\item $\mathcal{Y}$, the y-axis in $\R^{3}$.
				\begin{enumerate}
					...
					\item Let
						$\mathcal{A} = \{\vec a \in \R^{3} : \vec a = \beta \vec v
						\text{ for some }\vec v \in \mathcal{Y}, \beta \in \R \}$, then $\mathcal{A}
						\subseteq \mathcal{Y}$.
					...
					\item There exists a vector $\vec x \in \mathcal{Y}$ such that for
						all vectors $\vec v \in \mathcal{Y}$, $\vec x + \vec v = \vec e
						_{2}$.
				\end{enumerate}
			...
			\item $\mathcal{S}$, the set of vectors in $\R^{3}$ whose coordinates are $\pm
				...
				\begin{enumerate}
					...
					\item Let
						$\mathcal{A} = \{\vec a \in \R^{3} : \vec a = \beta \vec v
						\text{ for some }\vec v \in \mathcal{S}, \beta \in \R \}$, then $\mathcal{A}
						\subseteq \mathcal{S}$.
					...
					\item There exists a vector $\vec x \in \mathcal{S}$ such that for
						all vectors $\vec v \in \mathcal{S}$, $\vec x + \vec v = \vec 0$.
				\end{enumerate}
		\end{enumerate}

		\prob % Propose: Give students some practices on proving general statements about sets
		Determine whether the following statement is correct or not. If it is, prove it.
		Otherwise, give a counterexample.
		\begin{enumerate}
			\item For all sets $A \subseteq \R^{n}$, $A$ can be written as a set of linear
				combinations of vectors in $\R^{n}$.
