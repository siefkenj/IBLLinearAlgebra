...
% needed so that \pdfcreationdate exists for the `tectonics` engine.
% \pdfcreationdate is used by the pdfx package
\usepackage{xparse}
\ExplSyntaxOn
...
\NewExpandableDocumentCommand{\gettimedifference}{}
 {
  \str_if_eq_x:nnTF { \prop_item:Nn \g_getdate_data_prop {diff} } { Z }
   {
    0
   }
   {
