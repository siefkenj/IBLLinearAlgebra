	...
	\begin{parts}
		...
		\item What is $\Nullity(E)$, $\Nullity(E-3I)$, $\Nullity(E+3I)$?
			\begin{solution}
				...
				independent eigenvectors $\vec v_2,\vec v_{-1},\vec v_1$. Further, $\Span\Set{\vec v_i}\subseteq 
				\Null(E-\lambda_i I)$.				
				Since $\vec v_2,\vec v_{-1},\vec v_1\in\R^3$, it must be the case that $\Null(E-\lambda_i I)$ is one
				dimensional for $i\in\Set{2,-1,1}$.
			\end{solution}
	\end{parts}
