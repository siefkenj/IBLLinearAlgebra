...
\section*{Eigenvectors}
	...
	\begin{parts}[resume]
	\item If $\vec x=\vec v_1+3\vec v_2+4\vec v_4$ is $\vec x$ written as a linear combination
		of vectors in $\mathcal V$,
		compute $A\vec x$ as a linear combination of vectors in $\mathcal V$.
	\end{parts}
