...
\subsection*{$QR$ Decomposition}
	...
	space $\mathcal V$.
	\begin{parts}
		\item Use $C$ to define a linear transformation $T_C:\mathcal V\to\mathcal V$.
		\item Under what conditions is it garaunteed that $C[id]_{\mathscr A}^{\mathscr B}=C$?
		\item Under what conditions is it garaunteed that $C[id]_{\mathscr A}^{\mathscr B}=I$, where $I$
	...
	\question
	\begin{parts}
		\item If possible, write down a one-to-one linear transfomration with domain and codomain $\R^2$.
		\item If possible, write down an onto linear transfomration with domain and codomain $\R^2$.
		\item If possible, write down a one-to-one linear transfomration with domain $\R^2$ and codomain $\R^3$.
		\item If possible, write down an onto linear transfomration with domain $\R^2$ and codomain $\R^3$.
		\item If possible, write down a one-to-one linear transfomration with domain $\R^3$ and codomain $\R^2$.
		\item If possible, write down an onto linear transfomration with domain $\R^3$ and codomain $\R^2$.
	\end{parts}

	\begin{definition}[Kernel \& Range]
		Let $T:\mathcal V\to\mathcal W$ be a linear transformation.
	\end{definition}
